...
function BmiCopy() {
  ...
  function checkBmi() {
    if (calculation <= 18.5) {
      setBmi(
        <div>
          <span style={{ color: "green" ,textShadow:"2px grey"}}>Underweight</span>:BMI is 
          {calculation}
        </div>
      );
      ...
      setBmi(
        <div>
          <span style={{ color: "green",textShadow:"2px grey" }}>Healthy weight</span>:BMI is 
          {calculation}
        </div>
      );
      ...
      setBmi(
        <div>
          <span style={{ color: "rgb(243, 197, 11)",textShadow:"2px grey" }}>Overweight</span>:BMI is
          {calculation}
        </div>
      );
    } else {
      setBmi(
        <div>
          <span style={{ color: "red",textShadow:"2px grey" }}>Obesity</span>:BMI is
          {calculation}
        </div>
      );
